...
for(i in 1:10){
  AutoDataPolyLM <- lm(mpg~poly(horsepower,i) + poly(cylinders, i) + poly(displacement, i) + poly(weight, i) + poly(acceleration,i) + poly(year,i) + poly(origin, i), data = AutoDataPoly)
